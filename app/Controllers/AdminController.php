...
class AdminController { 
    ...
    public function blockUser($username, $reason){ 
        ...
        return json_encode($db->execute([':reason' => $reason, ':username' => $username]));
    }
    ...
    public function unblockUser($username){ 
        ...
        return json_encode($db->execute([':username' => $username]));
    }
    ...
    public function resetHighscores($gameSlug){ 
        ...
        return json_encode($db->execute([':slug' => $gameSlug])); 
    }
    ...
    public function deletePlayerScore($gameSlug, $username){ 
        ...
        return json_encode($db->execute([':slug' => $gameSlug, ':username' => $username])); 
    }
